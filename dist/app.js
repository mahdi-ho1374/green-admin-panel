...
mongoose_1.default
    .connect(`mongodb+srv://${process_1.default.env.MONGO_USERNAME}:${process_1.default.env.MONGO_PASSWORD}@admin-panel.czwa6yt.mongodb.net/${process_1.default.env.MONGO_DATABASE}`)
    .then((result) => {
