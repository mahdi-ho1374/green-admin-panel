...
const validateFetchRequest_1 = __importDefault(
  require("./validateFetchRequest")
);
exports.default = async ({
  ...
  const sortField = (
    ((_a = req.query) === null || _a === void 0 ? void 0 : _a.sortField) || ""
  )
    .trim()
    .toLowerCase();
  const sortBy = (
    ((_b = req.query) === null || _b === void 0 ? void 0 : _b.sortBy) || ""
  )
    .trim()
    .toLowerCase();
  const filterField = (
    ((_c = req.query) === null || _c === void 0 ? void 0 : _c.filterField) || ""
  )
    .trim()
    .toLowerCase();
  const filterTerm = (
    ((_d = req.query) === null || _d === void 0 ? void 0 : _d.filterTerm) || ""
  )
    .trim()
    .toLowerCase();
  const withinRange =
    (_e = req.query) === null || _e === void 0 ? void 0 : _e.withinRange;
  ...
  const filterQuery = !Object.keys(common_2.computedFilterProps).includes(
    filterField
  )
  ...
  const count =
    ((_g =
      (_f = result[0]) === null || _f === void 0 ? void 0 : _f.count[0]) ===
      null || _g === void 0
      ? void 0
      : _g.count) || 0;
